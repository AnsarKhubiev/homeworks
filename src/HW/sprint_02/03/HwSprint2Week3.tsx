...
type SetUsersType = (a: UserType[]) => void

export const pureAddUserCallback = (name: string, setUsers: SetUsersType, users: UserType[]) => { // need to fix any
    const user = {
        _id: v1(),
        name: name,
    }
